...
var APP_NAME_REGEX = /^[a-zA-Z0-9\-_]{3,64}$/g;
var SERVICE_NAME_REGEX = APP_NAME_REGEX;
...
module.exports = {
  ...
  serviceName: {
    ...
    validate: (input) => {
      if (typeof input === 'string' && SERVICE_NAME_REGEX.test(input)) {
        return true;
      }

      return 'Service name must match [a-zA-Z0-9\-_]{3,64}';
    }
  }
};
