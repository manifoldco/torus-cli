...
schema.validate = function (schemaPath, props) {
  return new Promise((resolve, reject) => {
    var contents = (typeof schemaPath === 'object') ?
      schemaPath : schema.get(schemaPath);

    // disable cyclic schema checking and disable unknown property checking
    var result = schema.validator.validateMultiple(
      props, contents, false, true);
