...
module.exports = function (deployment, descriptor, params) {
  return new Promise((resolve, reject) => {
    ...
    var accountId = params.provided.master_credentials.account_sid;
    var url = `${apiUrl.url}/${basePath}/Accounts/${accountId}/Keys.json`;
    var opts = {
      url: url,
      auth: {
        username: params.provided.master_credentials.account_sid,
        password: params.provided.master_credentials.token,
